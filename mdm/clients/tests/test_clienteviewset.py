...
class ValidateGenreTestCase(TestCase):
    ...
    def test_is_valid(self):
        ...
        self.assertEqual(
            ClientViewSet.validateGender(self, 'Manuel', 'H'),
            True
        )
        self.assertEqual(
            ClientViewSet.validateGender(self, 'Manuel', 'M'),
            True
        )
        self.assertEqual(
            ClientViewSet.validateGender(self, 'Manuel', 'O'),
            True
        )
...
class CheckDuplicateTestCase(TestCase):
    """Test CheckDuplicate function."""
    def setUp(self):
        self.cliente = Cliente.objects.create(
            nombrePila='Test',
            apellidoPat='Cliente',
